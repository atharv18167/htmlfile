#MACHINE LEARNING MODEL IMPLEMENTION (SPAM CLASSIFICATION)#
...
This project is part of CODTECH Python & Machine Learning Internship – Task 4, where the objective is to build a predictive machine learning model using Scikit-learn. 
The chosen application for this task is SMS Spam Detection, a classic text classification problem.
...
OUTPUT:page 1: <img width="621" height="720" alt="Image" src="https://github.com/user-attachments/assets/7d98e417-3a7d-48b3-97b9-7093071c4b0e" />
